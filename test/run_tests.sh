...
rostest mission_control test_watchdog.launch
rostest mission_control test_watchdog_fail_safe.launch
rostest mission_control test_watchdog_fail_safe_subprocess.launch
