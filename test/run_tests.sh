...
TESTS=(
  ...
  test_behaviour_subprocess_token_passing.launch
  test_behaviour_subprocess_token_passing2.launch
  test_behaviour_subprocess_token_passing_with_cpp_script.launch
  test_watchdog.launch
  test_watchdog_fail_safe.launch
  test_watchdog_fail_safe_subprocess.launch
