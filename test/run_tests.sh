...
rostest mission_control test_behaviour_subprocess_token_passing2.launch --text
...
rostest mission_control test_mission_control_utils_cpp_set_var.launch --text
rostest mission_control test_mission_control_utils_cpp_get_var.launch --text
